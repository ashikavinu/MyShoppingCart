function displayItems(filter_id)
{
	 ...
	 if( (myCookie!="") &&(myCookie!=null))
	 {
        ...
        {
		 document.getElementById(`i${myProducts[i]}`).value=qtyArray[i]
		}
...
if((user!="")&&(user!=null))
{
	...
	productArray=productsString.split(",")

	if(productArray.indexOf(String(product_id))!=-1)
	{
	...
	let myImgSrcArray=localStorage.getItem("imgSrcs").split(",")
	myImgSrcArray.push(imgSrc)
	localStorage.setItem("imgSrcs",myImgSrcArray)	
	populateQuantity()
...
else
{
   ...
   if((myuser!="")&&(myuser!=null))
   {
	...
	let myProductArray=new Array()
	myProductArray.push(product_id)

	localStorage.setItem("productsArray",myProductArray)

	let myPriceArray=new Array()
	myPriceArray.push(price)
	localStorage.setItem("prices",myPriceArray)

	let myImgSrcArray=new Array()
	myImgSrcArray.push(imgSrc)
...
{
	let cardDiv=`<img src="visa.png"><img src="mastercard.png"><img src="amex.jpg"><img src="discover.png">`
